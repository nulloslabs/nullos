...
typedef struct usb_hcd {
    ...
    int (*interrupt_transfer)(struct usb_hcd *hcd, usb_device_t *dev, uint8_t endpoint, void *data, uint16_t length);
    int (*bulk_transfer)(struct usb_hcd *hcd, usb_device_t *dev, uint8_t endpoint, void *data, uint16_t length);
