...
uint64_t get_monotonic_time_us(void) {
    if (is_hpet_available()) {
        ...
        if (!hpet_epoch_initialized) {
            ...
            hpet_epoch_offset_us = reference_us >= hpet_us ? (int64_t)(reference_us - hpet_us) : -(int64_t)(hpet_us - reference_us);
